...
#define SPI_FLASH_LOG_START 0x100000
#define SPI_FLASH_LOG_END 0x200000
#endif//ALIENTEK_MINI
...
#define FM_SECTORS_PER_ENV_BLOCK 4
#define FM_ENV_STORE_SIZE (FM_FLASH_SECTOR_SIZE*FM_SECTORS_PER_ENV_BLOCK)

#define FM_ENV_STORE_START_ADDR (0x800e000)
