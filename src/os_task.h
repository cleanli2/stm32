...
#define INTERRUPT_REGS_BAK_NUM 17
#define OFFINDEX_LR_CODE (INTERRUPT_REGS_BAK_NUM-9)
#define OFFINDEX_LR (INTERRUPT_REGS_BAK_NUM-3)
#define OFFINDEX_PC (INTERRUPT_REGS_BAK_NUM-2)
#define OFFINDEX_XPSR (INTERRUPT_REGS_BAK_NUM-1)
...
#define sleep_wait(task_to_wait, sleep_type) {\
    ...
    cur_os_task->task_status = sleep_type; irq_restore(irqsv); \
    os_switch_trigger();}
