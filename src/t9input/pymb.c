...
const unsigned char cy_mb_35    []={"·¨ÂÖ·¨ÂÉ"};
const unsigned char cy_mb_97    []={"ÒâÊ¶"};
const unsigned char cy_mb_29    []={"³ÉÎª´ËÍâ´íÎó³ÆÎª´ÓÎ´"};
const unsigned char cy_mb_79    []={"ËùÒÔËùÓĞÉùÒô"};
const unsigned char cy_mb_39    []={"¶«Î÷´óÑ§"};
const unsigned char cy_mb_55    []={"¿´¼û¿Õ¼ä¿Æ¼¼¿É¼û"};
const unsigned char cy_mb_57    []={"¿ÉÊÇ¿ªÊ¼¿´Êé"};
const unsigned char cy_mb_25    []={"³öÀ´´ÓÀ´´¦Àí³ıÁË"};
const unsigned char cy_mb_59    []={"¿ÉÒÔ¿ÆÑ§¿ÉĞ¦"};
const unsigned char cy_mb_99    []={"ÕâÑùÏÖÔÚÕâĞ©ÒòÎªÒÔÎªÓîÖæ"};
...
const unsigned char cy_mb_932   []={"ÖªµÀÒ»¶¨Ğí¶àÕæµÄÓĞµãÒ»µãÓĞµÄ"};
const unsigned char cy_mb_962   []={"ÔõÃ´ÕâÃ´ÔÛÃÇÎÒÃÇÍâÃæÎÄÃ÷"};
const unsigned char cy_mb_662   []={"ÄãÃÇÄÇÃ´Å©Ãñ"};
const unsigned char cy_mb_372   []={"µ«ÊÇµ±Ê±µØÉÏ"};
...
const unsigned char cy_mb_9429  []={"Õâ¸öÒÔºóÖĞ¹úÕû¸ö×î¸ßÒ²»áÒ²ºÃÒ²ºÜ"};
