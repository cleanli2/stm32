...
//words
const unsigned char cy_mb_2229  []={"³ö²î³£³£´Ó´Ë²ã´Î³¬³ö´«³Ğ"};
const unsigned char cy_mb_2329  []={"²¿·İ°ì·¨²»·Å²»·Á°İ·ğ"};
const unsigned char cy_mb_2429  []={"³É¹¦³¬¹ı´«¹¦"};
const unsigned char cy_mb_2529  []={"³öÀ´´ÓÀ´´¦Àí³ıÁË"};
const unsigned char cy_mb_2629  []={"²»ÄÜ±¾ÄÜ"};
...
const unsigned char cy_mb_9529  []={"×Ô¼ºÒÑ¾­ĞŞÁ¶ĞÄÀí"};
const unsigned char cy_mb_9629  []={"ÔõÃ´ÕâÃ´ÔÛÃÇÎÒÃÇÍâÃæÎÄÃ÷Ö»ÄÜÖ®ÄÚÔÚÄÄ×ÜÄÜ"};
const unsigned char cy_mb_9729  []={"ÒâÊ¶×ÔÈ»ÕâÈËÔğÈÎÖ®ÈËÕæÈËÖ»ÊÇÕâÊÇ×ÜÊÇÖªÊ¶ÕæÊµÕæÊÇÖÁÉÙÕâÊ±ÔÙËµ"};
