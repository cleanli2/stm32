...
#define BATV_LOW_LIMIT 3650

#define LEDLP_GPIO_PERIPH RCC_APB2Periph_GPIOA
#define LEDLP_GPIO_GROUP GPIOA
#define LEDLP_GPIO_PIN GPIO_Pin_1
#define LED1_GPIO_PERIPH RCC_APB2Periph_GPIOA
#define LED1_GPIO_GROUP GPIOA
#define LED1_GPIO_PIN GPIO_Pin_13
#define ADC_PWR_GPIO_PERIPH RCC_APB2Periph_GPIOA
#define ADC_PWR_GPIO_GROUP GPIOA
#define ADC_PWR_GPIO_PIN GPIO_Pin_7
#define SDA_GPIO_PERIPH RCC_APB2Periph_GPIOB
#define SDA_GPIO_GROUP GPIOB
#define SDA_GPIO_PIN GPIO_Pin_10
#define SCL_GPIO_PERIPH RCC_APB2Periph_GPIOB
#define SCL_GPIO_GROUP GPIOB
