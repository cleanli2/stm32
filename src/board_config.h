...
#define LED8S0_GPIO_PERIPH RCC_APB2Periph_GPIOA
#define LED8S0_GPIO_GROUP GPIOA
#define LED8S0_GPIO_PIN GPIO_Pin_14
#define LED8S1_GPIO_PERIPH RCC_APB2Periph_GPIOA
#define LED8S1_GPIO_GROUP GPIOA
#define LED8S1_GPIO_PIN GPIO_Pin_11
#define LED8S2_GPIO_PERIPH RCC_APB2Periph_GPIOA
#define LED8S2_GPIO_GROUP GPIOA
#define LED8S2_GPIO_PIN GPIO_Pin_12
...
#define LED8S1_GPIO_PERIPH RCC_APB2Periph_GPIOC
#define LED8S1_GPIO_GROUP GPIOC
#define LED8S1_GPIO_PIN GPIO_Pin_3
#define LED8S2_GPIO_PERIPH RCC_APB2Periph_GPIOA
#define LED8S2_GPIO_GROUP GPIOA
...
#define LED8S6_GPIO_PERIPH RCC_APB2Periph_GPIOB
#define LED8S6_GPIO_GROUP GPIOB
#define LED8S6_GPIO_PIN GPIO_Pin_12
#define LED8S7_GPIO_PERIPH RCC_APB2Periph_GPIOB
#define LED8S7_GPIO_GROUP GPIOB
#define LED8S7_GPIO_PIN GPIO_Pin_11
