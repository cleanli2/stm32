...
USART_TypeDef* COM_USART[COMn] = {BOARD_COM1, BOARD_COM2}; 

GPIO_TypeDef* COM_TX_PORT[COMn] = {BOARD_COM1_TX_GPIO_PORT, BOARD_COM2_TX_GPIO_PORT};
 
GPIO_TypeDef* COM_RX_PORT[COMn] = {BOARD_COM1_RX_GPIO_PORT, BOARD_COM2_RX_GPIO_PORT};
 
const uint32_t COM_USART_CLK[COMn] = {BOARD_COM1_CLK, BOARD_COM2_CLK};

const uint32_t COM_TX_PORT_CLK[COMn] = {BOARD_COM1_TX_GPIO_CLK, BOARD_COM2_TX_GPIO_CLK};
 
const uint32_t COM_RX_PORT_CLK[COMn] = {BOARD_COM1_RX_GPIO_CLK, BOARD_COM2_RX_GPIO_CLK};

const uint16_t COM_TX_PIN[COMn] = {BOARD_COM1_TX_PIN, BOARD_COM2_TX_PIN};

const uint16_t COM_RX_PIN[COMn] = {BOARD_COM1_RX_PIN, BOARD_COM2_RX_PIN};
